...
<head>
    <meta charset="utf-8">
    <title>Laporan Penagihan Reseller</title>
    <style>
        @page {
            size: A4 portrait;
            margin: 1.2cm;
    ...
    <table class="header-table">
        <tr>
            ...
            <td class="report-title-block">
                <div class="report-title">LAPORAN PENAGIHAN RESELLER</div>
    ...
    <table class="data-table">
        <thead>
            <tr>
                ...
                <th style="width: 10%;" class="text-right">Total Tagihan</th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>Bayar Tempo</td>
                <td class="text-right">Rp {{ number_format($invoice->total_debt, 0, ',', '.') }}</td>
                <td class="text-center">{{ $invoice->status->label() }}</td>
            </tr>
            @empty
            <tr>
